...
@JsonIgnoreProperties({
        "course",
        "learningObjectiveStatuses",
        "evaluationIndicatorStatuses",
        "reports",
        "practicalObjectives",
...
public class Student implements Serializable {
    ...
    @JsonIgnore
    private Set<EvaluationIndicatorStatus> evaluationIndicatorStatuses = new HashSet<>();
    ...
    @JsonIgnore
    private Set<PracticalObjective> practicalObjectives = new HashSet<>();
    ...
    @JsonIgnore
    private Set<SpecialEducationalNeed> specialEducationalNeeds = new HashSet<>();
